...
import 'package:sate_social/features/community/presentation/blocks/purchase_post/purchase_post_cubit.dart';
import 'package:sate_social/features/community/presentation/blocks/purchase_post/purchase_post_state.dart';
        ...
        BlocProvider(
            create: (context) => CreatePostCubit(
                ...
                uploadDocUseCase: UploadDocUseCase(
                    postRepository: context.read<PostRepository>()))),
        BlocProvider(create: (context) => PurchasePostCubit())
      ],
        ...
        child: Scaffold(
            ...
            body: MultiBlocListener(
                listeners: [
                  ...
                  BlocListener<PurchasePostCubit, PurchasePostState>(
                      listener: (context, state) {
                        if (state is PurchasePostSuccess) {
                          context
                              .read<CreatePostCubit>()
                              .submitPost();
                        }
                        if (state is PurchasePostFailure) {
                          Get.back();
                        }
                      }),
                ],
                      ...
                      Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              context.read<CreatePostCubit>().isGigCategory()
                                  ? Row(
                                      mainAxisAlignment:
                                  ...
                                  child: Row(children: [
                                    ...
                                    Expanded(
                                      ...
                                      onChanged: (String? value) {
                                        updatePostGroupsList(context, value!);
                                        context
                                            .read<CreatePostCubit>()
